...
change by 黎慧剑 2019.11.14 : 解决中文文件名乱码问题
        ...
        while total < size_cd:
            ...
            if flags & 0x800:
                ...
                if chardet is None:
                    ...
                    _encoding = chardet.detect(filename)['encoding']
                    if _encoding in ['KOI8-R'] or _encoding.startswith('ISO-8859'):
                        _encoding = 'gbk'
                    filename = filename.decode(_encoding)
        ...
        try:
            ...
            if zinfo.flag_bits & 0x800:
                ...
                if chardet is None:
                    ...
                    _encoding = chardet.detect(fname)['encoding']
                    if _encoding in ['KOI8-R'] or _encoding.startswith('ISO-8859'):
                        _encoding = 'gbk'
                    fname_str = fname.decode(_encoding)
