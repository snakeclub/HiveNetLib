...
htmlhelp_basename = 'HiveNetLibdoc'
...
latex_documents = [
    (master_doc, 'HiveNetLib.tex', 'HiveNetLib Documentation',
     '黎慧剑', 'manual'),
]
...
man_pages = [
    (master_doc, 'hivenetlib', 'HiveNetLib Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HiveNetLib', 'HiveNetLib Documentation',
     author, 'HiveNetLib', 'One line description of project.',
     'Miscellaneous'),
]
