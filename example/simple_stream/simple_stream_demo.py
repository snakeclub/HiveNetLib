...
"""
简单流处理Demo
@module simple_stream_demo
@file simple_stream_demo.py
"""
...
__MOUDLE__ = 'simple_stream_demo'  # 模块名
__DESCRIPT__ = u'简单流处理Demo'  # 模块描述
...
def test_string_stream_2():
    ...
    _stream1 = StringStream(stop_by_excepiton=False, logger=_logger,
                            dealer_exception_fun=dealer_exception_fun, stream_closed_fun=stream_closed_fun)
